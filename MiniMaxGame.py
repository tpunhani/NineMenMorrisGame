...
class MiniMaxGame:
    '''
    Program plays a move in the midgame/endgame phase of the game.
    '''
...
boardPosition = morrisVariantUtil.readInputFile(miniMaxGame.inFile)
generatedPosition = miniMaxGame.maxMin(boardPosition, miniMaxGame.depth)
print(f'Input position: {boardPosition} Output position: {generatedPosition}')
print(f'Position evaluated by static estimation: {miniMaxGame.positionsEvaluated}')
print(f'MINIMAX Estimate: {miniMaxGame.minimax_estimate}')
morrisVariantUtil.writeOutputFile(miniMaxGame.outFile, generatedPosition)
miniMaxGame.checkForWin()